            ...
            <h2 className='text-[#2648EA] font-semibold text-3xl'>Who’s on Shift</h2>
                <div className='bg-white w-40 h-40 flex justify-center items-center rounded-lg'>
                    <div className='w-[50%] h-[50%]'>
                        <Image className='w-full h-full' src="/assets/images/profile.jpg" width={50} height={50} alt='profileImage'/>
                    </div>
                </div>
             <div><span>Back to</span>{" "}<a href="/login" className='text-[#2648EA]'>Login</a></div>
        </div>

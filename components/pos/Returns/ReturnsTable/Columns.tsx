...
const ActionsCell = ({ row }: CellContext<ReturnsHistory, unknown>) => {
    const payment = row.original;
    const [selectedItem, setSelectedItem] = useState<ReturnsHistory | null>(
      null
    );
...
export const returnHistoryColumns: ColumnDef<ReturnsHistory>[] = [
  {

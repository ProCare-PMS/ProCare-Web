...
const OrderList = ({
  ...
  return (
    <div className="w-full pl-4 transition-all bg-white shadow-custom p-4  rounded-[8px]">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold mb-4">Order List</h2>
        <FaMinus onClick={onToggleOrderList} className="cursor-pointer" /> {/* Handle click */}
      </div>

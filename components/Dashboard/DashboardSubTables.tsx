        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-gray-100 rounded-lg">
              <TableHead className="w-[180px] font-nunito_sans text-gray-900 font-bold">
                Product Name
              </TableHead>
              <TableHead className="text-gray-900 font-nunito_sans font-bold">
                No. Remaining
              </TableHead>
              <TableHead className="w-[150px] text-gray-900 font-nunito_sans font-bold">
                Expiry Date
              </TableHead>
            </TableRow>
          </TableHeader>
            ...
            {isLoading
              ? Array.from({ length: 5 }).map((_, index) => (
                  <TableRow key={index}>
                    {[32, 16, 24].map((width, i) => (
                      <TableCell key={i}>
                        <div
                          className={`h-4 bg-gray-200 rounded w-${width} animate-pulse`}
                        />
                      </TableCell>
                    ))}
                  </TableRow>
              ...
              ? getCurrentPageItems()?.map((invoice) => (
                  <TableRow key={invoice?.name}>
                    <TableCell className="font-semibold text-sm font-inter text-gray-900">
                      {invoice?.name}
                    </TableCell>
                    <TableCell className="text-sm font-medium font-nunito_sans text-gray-900">
                      {invoice?.quantity}
                    </TableCell>
                    <TableCell className="font-semibold text-sm font-nunito_sans text-gray-900">
